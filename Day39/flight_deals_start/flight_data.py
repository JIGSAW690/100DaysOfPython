...
def find_cheapest_flight(data):
    ...
    origin = first_flight["itineraries"][0]["segments"][0]["departure"]["iataCodes"]
    destination = first_flight["itineraries"][0]["segments"][0]["arrival"]["iataCodes"]
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            lowest_price = price
            origin = flight["itineraries"][0]["segments"][0]["departure"]["iataCodes"]
            destination = flight["itineraries"][0]["segments"][0]["arrival"]["iataCodes"]
